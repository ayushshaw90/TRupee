...
TZIP16_Metadata_Base = {
    "name"          : "TRupee",
    "description"   : "It is a crptocurrency.",
    "authors"       : [
        "Ayush Shaw <ayushshaw127@gmail.com>"
    ],
    "homepage"      : "https://crpto.ayushshaw.co",
    "interfaces"    : [
        "TZIP-007-2021-04-17",
        "TZIP-016-2021-04-17"
    ],
...
if "templates" not in __name__:
    ...
    def test():
        ...
        admin = sp.address("tz1bkUYFGNuTruD8B5WCXuu4YZjzynT4GL8c")
        ...
        token_metadata = {
            "decimals"    : "10",               # Mandatory by the spec
            "name"        : "TRupee",   # Recommended
            "symbol"      : "TR",              # Recommended
            # Extra fields
            "icon"        : 'https://smartpy.io/static/img/logo-only.svg'
        }
        contract_metadata = {
            "" : "https://gateway.pinata.cloud/ipfs/QmZFrEXLPvsDp73P2XG5v6zRMJNMVhvTUDm2N35yDrcBGB",
        }
        c1 = FA12(
            admin,
        ...
        scenario.verify_equal(
            ...
            sp.some(
                sp.record(
                    token_id = 0,
                    token_info = sp.map({
                        "decimals"    : sp.utils.bytes_of_string("10"),
                        "name"        : sp.utils.bytes_of_string("TRupee"),
                        "symbol"      : sp.utils.bytes_of_string("TR"),
        ...
        scenario.verify(
            c1.data.metadata[""] == sp.utils.bytes_of_string("https://gateway.pinata.cloud/ipfs/QmZFrEXLPvsDp73P2XG5v6zRMJNMVhvTUDm2N35yDrcBGB")
        )
    ...
    sp.add_compilation_target(
        "FA1_2",
        FA12(
            admin   = sp.address("tz1SUXW6jJhaBpnehwe6MPFUdCenkv7weL3T"),
            config  = FA12_config(
